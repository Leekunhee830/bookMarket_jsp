...
public class ProductDto {
	...
	public String getPd_contents() {
		return pd_contents;
	}
	public void setPd_contents(String pd_contents) {
		this.pd_contents = pd_contents;
	}
	...
	public String getPd_regdate() {
		return pd_regdate;
	}
	public void setPd_regdate(String pd_regdate) {
